...
void main() {
  ...
  group('save watchlist', () {
    ...
    test('should return success message when insert to database tv is success',
        () async {
      //arrange
    ...
    test('should throw DatabaseException when insert to database Tv is failed',
        () async {
      //arrange
  ...
  group('remove watchlist', () {
    ...
    test(
        'should return success message when remove from database tv is success',
        () async {
      // arrange
    ...
    test('should throw DatabaseException when remove from database tv is failed',
        () async {
      // arrange
      when(mockDatabaseHelper.removeWatchlistTv(testTvTable))
          .thenThrow(Exception());
  ...
  group('Get Movie Detail By Id', () {
    ...
    test('should return null when data Tv is not found', () async {
      // arrange
